...
async function budgetLeft(env) {
  ...
  // лічильник застарів або зі старого формату (без at) → дозволяємо пробний запит, щоб дізнатись реальний залишок
  // (ламає дедлок, коли разовий 429 записав rem:0 і Worker перестав ходити до HL)
